		...
		<table class="table table-hover">  
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align: center;"><img id="lvicon" src=""> </td>
					<script>
						var level = g_level(${user.point});
						$("#lvicon").prop("src","./image/level/lv"+level+".gif");
					</script>
					...
					<td id="userwrite" style="text-align: center;"></td>
					<script>
